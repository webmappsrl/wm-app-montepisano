...
-(CDVPluginResult*) executeSqlWithDict: (NSMutableDictionary*)options andArgs: (NSMutableDictionary*)dbargs
{
    ...
    int previousRowsAffected, nowRowsAffected, diffRowsAffected, blobSize;
                ...
                while (i < count) {
                    ...
                    switch (column_type) {
                        ...
                        case SQLITE_FLOAT:
                            ...
                            break;
                        case SQLITE_BLOB:
                            blobSize = sqlite3_column_bytes(statement, i);
                            blobData = [[NSData alloc] initWithBytes:sqlite3_column_blob(statement, i) length: (NSUInteger)blobSize];
                            columnValue = [blobData base64EncodedStringWithOptions:0];
                            break;
                        case SQLITE_TEXT:
