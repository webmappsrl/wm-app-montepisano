            ...
            GeolocationService.enable().then(function () {
                ...
                GeolocationService.switchState()
                    .then(function (value) {
                        ...
                        expect(value).toEqual({ isActive: true, isLoading: false, isFollowing: true, isRotating: true });
    ...
    describe("startRecording", function () {
        ...
        it('!recordingState.isActive  => it should start recording ', function (done) {
            ...
            promise.then(function (val) {
                ...
                expect($rootScope.$emit).toHaveBeenCalledWith('recordingState-changed', { isActive: true, isPaused: false });
            })
            $httpBackend.flush();
        })
