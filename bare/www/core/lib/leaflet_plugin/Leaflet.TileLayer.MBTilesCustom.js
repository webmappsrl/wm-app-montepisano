...
L.TileLayer.MBTilesCustom = L.TileLayer.extend({
  cordova: false,
  _cStmt: '',
...
*/
L.tileLayer.mbTilesCustom = function (databaseUrl, options) {
  return new L.TileLayer.MBTilesCustom(databaseUrl, options);
}
