(function() {
  ...
  angular.module('countrySelect', []).directive('countrySelect', function($translate) {
    var allCountries;
    allCountries = [
      {
        code: 'AF',
    ...
    return {
      ...
      template: '<select ng-options="country.code as country.name for country in countries"> <option value="" ng-if="isSelectionOptional">{{"Seleziona paese" | translate}}</option> </select>',
      controller: [
