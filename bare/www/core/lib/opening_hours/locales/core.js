        ...
        de: { /* {{{ */
            opening_hours: {
                "texts": {
                    ...
                    'public holiday part2': ' Leider ist der "tag key" (beispielsweise "opening_hours", oder "lit") in opening_hours.js nicht bekannt.'
                    ...
                    'point in time': 'Erwarte Bindestrich (-) oder offenes Ende (+) in der Zeitspanne __calc__.'
                        ...
                        + ' Vielleicht falsches OSM-tag verwendet?',
                    ...
                    'week period less than 2': 'Du hast eine Wochenperiode kleiner 2 angegeben.'
                        + ' Wenn du die gesamte Spanne von __weekfrom__ bis __weekto__ angeben willst, lasse "/__period__" einfach weg.',
